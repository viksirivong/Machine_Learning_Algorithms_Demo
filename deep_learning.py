...
# SPECIFICATION:    The program learns how to classify fashion items. It will use the dataset Fashion MNIST, 
#                   which includes 70,000 grayscale images of 28×28 pixels each, with 10 classes, each class 
#                   representing a fashion item as illustrated below. It will use Keras to load the dataset 
#                   which includes 60,000 images for training and 10,000 for test. The goal is to train and 
#                   test multiple deep neural networks and check their corresponding performances, always updating 
#                   the highest accuracy found. Finally, the weights of the best model will be printed, together 
#                   with the architecture and the learning curves. 
